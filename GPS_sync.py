...
if __name__ == "__main__":
    ...
    parser.add_argument('--folder-cam', type=str, help='Path to the folder containing camera CSV files')
    ...
    main(args.main_folder, args.folder_cam, args.total_frames, args.threshold_min, args.threshold_max, args.colmap_path)
